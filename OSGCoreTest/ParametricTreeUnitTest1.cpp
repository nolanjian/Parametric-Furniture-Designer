...
TEST(ParametricTree, RegexTest1)
{
	...
	Parametric::regexParseFormular(" A = 800 ", strKey, strVal);
...
{
	std::string strKey, strVal;
	Parametric::regexParseFormular(" W=800 ", strKey, strVal);
...
{
	std::string strKey, strVal;
	Parametric::regexParseFormular("Q=800", strKey, strVal);
...
{
	std::string strKey, strVal;
	bool bRet = Parametric::regexParseFormular("Q", strKey, strVal);
	EXPECT_EQ(bRet, false);

	bool bRet1 = Parametric::regexParseFormular("Q=", strKey, strVal);
	EXPECT_EQ(bRet1, false);
}
